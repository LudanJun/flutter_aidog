...
/// 我的-宠主-帮养信息-照顾方式选择
class MyPetChooseZhaogustylePage extends StatefulWidget {
  const MyPetChooseZhaogustylePage({super.key});

  @override
  State<MyPetChooseZhaogustylePage> createState() =>
      _MyPetChooseZhaogustylePageState();
}

class _MyPetChooseZhaogustylePageState
    extends State<MyPetChooseZhaogustylePage> {
  @override
                ...
                children: [
                    ...
                    onTap: () {
                      setState(() {
                        Provider.of<MyProvider>(context, listen: false)
                            .selectPetDogZhaogufangshiValue = "遛狗";
                        AALog(
                            "遛狗:${Provider.of<MyProvider>(context, listen: false).selectPetDogZhaogufangshiValue}");
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          if (Provider.of<MyProvider>(context, listen: false)
                                  .selectPetDogZhaogufangshiValue ==
                              "遛狗")
                            Image(
                  ...
                  InkWell(
                    onTap: () async {
                      setState(() {
                        Provider.of<MyProvider>(context, listen: false)
                            .selectPetDogZhaogufangshiValue = "帮养";
                        AALog(
                            "帮养:${Provider.of<MyProvider>(context, listen: false).selectPetDogZhaogufangshiValue}");
                  ...
                  InkWell(
                    onTap: () async {
                      setState(() {
                        Provider.of<MyProvider>(context, listen: false)
                            .selectPetDogZhaogufangshiValue = "两者均可";
                        AALog(
                            "两者均可:${Provider.of<MyProvider>(context, listen: false).selectPetDogZhaogufangshiValue}");
