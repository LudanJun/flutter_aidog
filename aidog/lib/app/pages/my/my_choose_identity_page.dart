...
///帮养人 身份切换
class MyChooseIdentityPage extends StatefulWidget {
  const MyChooseIdentityPage({super.key});

  @override
  State<MyChooseIdentityPage> createState() => _MyChooseIdentityPageState();
}

class _MyChooseIdentityPageState extends State<MyChooseIdentityPage> {
  @override
                ...
                children: [
                    ...
                    onTap: () {
                      setState(() {
                        Provider.of<MyProvider>(context, listen: false)
                            .selectIdentityValue = "学生党";
                        AALog(
                            "学生党:${Provider.of<MyProvider>(context, listen: false).selectIdentityValue}");
                  ...
                  InkWell(
                    onTap: () async {
                      setState(() {
                        Provider.of<MyProvider>(context, listen: false)
                            .selectIdentityValue = "上班族";
                        AALog(
                            "上班族:${Provider.of<MyProvider>(context, listen: false).selectIdentityValue}");
                        EasyLoading.show(status: '切换中...');
                        Future.delayed(
                          const Duration(seconds: 1),
                          () {
                  ...
                  InkWell(
                    onTap: () async {
                      setState(() {
                        Provider.of<MyProvider>(context, listen: false)
                            .selectIdentityValue = "自由职业";
                        AALog(
                            "自由职业:${Provider.of<MyProvider>(context, listen: false).selectIdentityValue}");
                        EasyLoading.show(status: '切换中...');
                        Future.delayed(
                          const Duration(seconds: 1),
                          () {
