...
/// 帮养人 信息完善
class LoginHelpOtherInfoPage extends StatefulWidget {
  const LoginHelpOtherInfoPage({super.key});

  @override
  State<LoginHelpOtherInfoPage> createState() => _LoginHelpOtherInfoPageState();
}

class _LoginHelpOtherInfoPageState extends State<LoginHelpOtherInfoPage> {
  ...
  void initState() {
    ...
    //     AALog("_description $_description");
    //     //以map形式传地图数据
