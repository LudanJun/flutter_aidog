        ...
        children: [
          ...
          Expanded(
            child: TabBarView(
              ...
              children: _homeProvider.subTabList.map((value) {
                return EasyRefresh(
  ...
  Widget headView() {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Container(
            width: ScreenAdapter.getScreenWidth() - padding_30 * 2,
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: Colors.amber,
                                  borderRadius:
                                      BorderRadius.circular(padding_20),
                                ),
                              ),
                              Container(
                                child: Text(
